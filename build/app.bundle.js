...
$(document).ready(function () {
  ...
  $("#quiz-1").on("click", function () {
    ...
    } else if ($("#quiz-1").hasClass("quiz-1-sidebar")) {
  ...
  function getQuestion(quizChoice, currentQuestion, correctAnswers, wrongAnswers) {
    ...
    $.getJSON('build/quiz.json', function (data) {
      ...
      var title = data.quizzes[quizChoice].title;
      var question = data.quizzes[quizChoice].questions[currentQuestion].question;
      ...
      for (var i = 0; i < 4; i++) {
        ...
        var answers = data.quizzes[quizChoice].questions[currentQuestion].answers[i].content;
  ...
  function gameOver(correctAnswers, wrongAnswers) {
    ...
    if (correctAnswers > wrongAnswers) {
      $(".game-over").html("<h1>A winner is you!</h1></br><h3> Final score: " + correctAnswers + ":" + wrongAnswers + "</h3>");
    } else {
